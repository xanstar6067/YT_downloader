...
6. Машиночитаемый UTF-8-вывод `--progress-template` преобразуется в состояние интерфейса; для плейлиста учитываются текущая позиция и общее количество элементов. При отмене дочерний процесс завершается целиком.
